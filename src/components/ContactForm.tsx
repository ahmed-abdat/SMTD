  ...
  return (
    <div className={`min-h-screen bg-gray-100 flex items-center justify-center p-4 md:py-0`}>
      <div className="max-w-4xl w-full flex flex-col md:flex-row gap-y-6 md:gap-y-0 md:gap-x-6">
        ...
        <div className={`md:w-1/2 p-6 bg-gradient-to-b from-blue-500 to-blue-700 rounded-lg text-white ${isRTL ? 'md:order-2' : 'md:order-1'}`}>
        ...
        <div className={`md:w-1/2 bg-white text-gray-900 p-6 rounded-lg shadow-lg ${isRTL ? 'md:order-1' : 'md:order-2'}`}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                {...register("message")}
                rows={4}
                className={`mt-1 block w-full ${errors.message ? 'border-red-500' : ''}`}
